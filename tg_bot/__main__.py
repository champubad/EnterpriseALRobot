...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/SigmaOFF_Topic'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/SigmaOFF_Topic',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/SigmaMirrorz",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "Owner"),
                                url="https://t.me/Hamza_vibes",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [InlineKeyboardButton(text="Back", callback_data="help_back"),
                     InlineKeyboardButton(text='Support', url='https://t.me/SigmaOFF_Topic')]
                )
                send_help(
                    chat.id,
                    text,
